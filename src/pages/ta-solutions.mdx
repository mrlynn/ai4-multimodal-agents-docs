...
# 🔐 TA Solutions & Resources

:::danger ⚠️ FOR TEACHING ASSISTANTS ONLY
...
# Logistics
:::note Location
The workshop is in the MGM Grande in room 104 - 
Michael's Mobile: (215) 866-6036
:::
...
- **Workshop Documentation**: [mdb.link/ai4-docs](https://mdb.link/ai4-docs)
- **MongoDB Learn Course**: [mdb.link/ai4-badge](https://mdb.link/ai4-badge)
- **Voyage AI Multimodal Guide**: [mdb.link/ai4-vlm](https://mdb.link/ai4-vlm)

### 🚀 Demo Applications
- **Live Agent Demo**: [mdb.link/ai4-agent](https://mdb.link/ai4-agent)
- **Alternative Link**: [mdb.link/ai4](mdb.link/ai4)

### 💻 Code Repositories
- **Demo Repository**: [mdb.link/ai4-demo](https://mdb.link/ai4-demo)
- **Workshop Repository**: [mdb.link/ai4-workshop](mdb.link/ai4-workshop)

### 📊 Feedback & Survey
- **Workshop Survey**: [mdb.link/ai4-survey](https://mdb.link/ai4-survey)
...
- ✅ Verify index status: `collection.list_search_indexes()`
- ✅ Check index name matches: `VS_INDEX_NAME = "vector_index"`
- ✅ Confirm 1024 dimensions for Voyage multimodal embeddings
...
- ✅ Check session_id index: `history_collection.create_index("session_id")`
- ✅ Verify timestamp sorting: `.sort("timestamp", 1)`
- ✅ Confirm message structure includes all required fields
...
- **ReAct Pattern**: Explain the reasoning → acting → reasoning loop
...
- **Technical Issues**: Check MongoDB Developer Community - Forums - Contact Apoorva/Michael Afterwards
