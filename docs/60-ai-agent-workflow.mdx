...
- Basic implementation: [03-multimodal-agent.json](https://mongodb-developer.github.io/multimodal-pdf-agent-n8n/workflows/03-multimodal-agent.json)
- Production-ready: [05-real-multimodal-agent.json](https://mongodb-developer.github.io/multimodal-pdf-agent-n8n/workflows/05-real-multimodal-agent.json)
- With web interface: [07-form-based-agent.json](https://mongodb-developer.github.io/multimodal-pdf-agent-n8n/workflows/07-form-based-agent.json)
:::
