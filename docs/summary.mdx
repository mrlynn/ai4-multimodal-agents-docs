...
### MongoDB Resources  
- [MongoDB Atlas Vector Search](https://www.mongodb.com/products/platform/atlas-vector-search?utm_campaign=devrel&utm_source=workshop&utm_medium=cta&utm_content=multimodal_pdf_agent_n8n&utm_term=michael.lynn)
- [Vector Search Tutorial](https://www.mongodb.com/developer/products/atlas/semantic-search-mongodb-atlas-vector-search/?utm_campaign=devrel&utm_source=workshop&utm_medium=cta&utm_content=multimodal_pdf_agent_n8n&utm_term=michael.lynn)
- [MongoDB Developer Center](https://www.mongodb.com/developer/?utm_campaign=devrel&utm_source=workshop&utm_medium=cta&utm_content=multimodal_pdf_agent_n8n&utm_term=michael.lynn)

### AI/ML Resources
- [Voyage AI Documentation](https://docs.voyageai.com)
- [Gemini AI Documentation](https://ai.google.dev/docs)
- [RAG Best Practices](https://www.mongodb.com/developer/products/atlas/retrieval-augmented-generation-rag/?utm_campaign=devrel&utm_source=workshop&utm_medium=cta&utm_content=multimodal_pdf_agent_n8n&utm_term=michael.lynn)
