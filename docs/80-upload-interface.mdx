...
```
/workspaces/ai4-multimodal-agents-n8n/static/upload-interface.html
```
...
```
/workspaces/ai4-multimodal-agents-n8n/init/workflows/06-real-voyage-multimodal.json
```
...
Edit `/static/upload-interface.html` to:
