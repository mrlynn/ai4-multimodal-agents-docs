...
- Context-3 implementation: [08-voyage-context-3-embeddings.json](/multimodal-pdf-agent-n8n/workflows/08-voyage-context-3-embeddings.json)
- Hybrid approach: [09-hybrid-multimodal-context-agent.json](/multimodal-pdf-agent-n8n/workflows/09-hybrid-multimodal-context-agent.json)
:::
