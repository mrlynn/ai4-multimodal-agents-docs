...
1. **Download**: [01-getting-started.json](/multimodal-pdf-agent-n8n/workflows/01-getting-started.json)
...
- [02 - PDF Processor](/multimodal-pdf-agent-n8n/workflows/02-pdf-processor.json) - Process your first PDF
- [03 - Multimodal Agent](/multimodal-pdf-agent-n8n/workflows/03-multimodal-agent.json) - Create an AI agent
