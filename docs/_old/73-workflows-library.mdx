...
### 📄 Workshop Test Document

All workflows are pre-configured to work with our test document:
**[Recent arXiv AI Research Paper](https://arxiv.org/pdf/2501.12948)**

This paper provides excellent test content with:
- Complex technical language for Context-3 testing
- Mathematical diagrams for multimodal processing  
- Multi-page structure for batch processing
- Current AI research relevant to conference attendees
...
#### 01 - Getting Started
- **Download**: [01-getting-started.json](/workflows/01-getting-started.json)
- **Purpose**: Test environment and verify setup
- **Concepts**: Webhooks, basic nodes, response handling
- **Difficulty**: Beginner

#### 02 - PDF Processor  
- **Download**: [02-pdf-processor.json](/workflows/02-pdf-processor.json)
...
#### 03 - Multimodal Agent
- **Download**: [03-multimodal-agent.json](/workflows/03-multimodal-agent.json)
- **Purpose**: Basic multimodal agent processing
- **Concepts**: Multimodal embeddings, vector search, AI responses
- **Difficulty**: Intermediate

#### 04 - Complete Agent (Mock)
- **Download**: [04-complete-agent-mock.json](/workflows/04-complete-agent-mock.json)  
...
- **Download**: [05-real-multimodal-agent.json](/workflows/05-real-multimodal-agent.json)
- **Purpose**: Production-ready multimodal agent
- **Concepts**: Production patterns, real APIs, advanced RAG
- **Difficulty**: Advanced

#### 06 - Real Voyage Multimodal
- **Download**: [06-real-voyage-multimodal.json](/workflows/06-real-voyage-multimodal.json)
- **Purpose**: Advanced Voyage AI multimodal capabilities
- **Concepts**: Image embeddings, visual search, multimodal RAG
- **Difficulty**: Advanced

#### 07 - Form-Based Agent  
- **Download**: [07-form-based-agent.json](/workflows/07-form-based-agent.json)
...
- **Download**: [08-voyage-context-3-embeddings.json](/workflows/08-voyage-context-3-embeddings.json)
...
- **Download**: [09-hybrid-multimodal-context-agent.json](/workflows/09-hybrid-multimodal-context-agent.json)
